...
const copy = {
  zh: {
    ...
    flowLiubai: '课堂讲义挖空与离线导出',
    viewAllProjects: '查看全部项目',
    pageBack: '首页',
    projectsEyebrow: '项目目录 · 4 个项目',
    ...
    projectLiubaiType: '教师网页工具',
    projectLiubaiDescription: '将课文整理为可编辑的课堂挖空讲义，支持版式调整、直接复制与离线使用。',
    openProject: '打开项目',
  ...
  en: {
    ...
    flowLiubai: 'CLASSROOM CLOZE WORKSHEETS AND OFFLINE EXPORT',
    viewAllProjects: 'VIEW ALL PROJECTS',
    pageBack: 'HOME',
    projectsEyebrow: 'PROJECT DIRECTORY · 4 PROJECTS',
    ...
    projectLiubaiType: 'TEACHER WEB TOOL',
    projectLiubaiDescription: 'Turns classroom texts into editable cloze worksheets, with layout controls, direct copying, and offline use.',
